...
public class HomeFragment extends Fragment {
    ...
    private TextView tvUsuario, tvEntidad, tvCountHojarutadetalle, tvCountHojaruta, tvClientes ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        HojarutadetalleController hrc = new HojarutadetalleController(getContext());
        HojarutaController hr = new HojarutaController(getContext());
        ClienteController cr = new ClienteController(getContext());



        // MOSTRAR PEDIDOS PENDIENTES
        // MOSTRAR PEDIDOS ENVIADOS
        // BOTON ENVIAR TODOS LOS PEDIDOS PENDIENTES
